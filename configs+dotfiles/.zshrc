...
alias matrix='clear ; cmatrix -bs -C blue'
alias restartcomp='sudo shutdown -r 0'
alias off='sudo shutdown -h 0'
alias gay='toilet --gay -f mono9 -t'
alias gayb='gay -F border:gay -t'
alias metal='toilet --metal -f mono9 -t'
alias metalb='metal -F border:metal -t'
...
alias metalt='toilet --metal -f term -t'
...
alias du='cdu -d ch'
alias chgentoo='su -c "chroot /home/diavorian/gentoo /bin/zsh"'
