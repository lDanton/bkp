...
if [ "`mpc 2>&1 | wc -l`" -gt "1" ]; then
   ...
   (echo mpd; echo " "; echo "np: $np"; echo "artist: $artist"; echo "album: $album"; echo "time: $ti"; sleep 1) | dzen2 -bg $BG2 -fg $FG2 -fn $FONT -x $XPOS -y $YPOS -w $WIDTH -h $HEIGHT -l $LINES -e 'onstart=uncollapse;button1=exit;button2=exit;button3=exit;button4=exit;button5=exit'
else
